...
<body>
    <div class="relative flex justify-center items-center lg:container lg:mx-auto md:container md:mx-auto sm:container sm:mx-auto w-full h-screen bg-violet-800">
        <div class="card px-3 py-4 bg-white rounded w-2/5">
            <header class="text-center flex justify-between items-center mb-8">
                <h1 class="font-semibold text-lg">Admin Log in</h1>
                <a href="/mvc-app/home/"><button class="py-1 px-2 focus:outline-none focus:ring ring-red-100 rounded text-red-400"><i class='bx bx-exit pr-2' ></i>Cancel</button></a>
            </header>
            <form class="py-2">
                ...
                <label class="block col-span-1 col-start-3 w-full">
                    <button type="submit" name="submit" class="w-full border bg-violet-800 text-white border-2 rounded mt-5 py-2 px-5 border-violet-800 focus:outline-none focus:ring ring-violet-700 hover:bg-violet-600 hover:border-violet-600 hover:text-white transition-colors">Log in</button>
                </label>
            </form>
        </div>
    </div>
