    ...
    <div class="relative flex justify-center items-center lg:container lg:mx-auto md:container md:mx-auto sm:container sm:mx-auto w-full h-screen bg-violet-800">
        <div class="card px-6 py-4 bg-white rounded w-4/5">
            ...
            <div class="add-tour-form">
                <form action="<?php echo $data["tour_id"];?>" class="grid md:grid-cols-3 gap-y-4 gap-x-7" method="POST" enctype="multipart/form-data">
                    <label class="block w-full">
                        <span class="block text-sm font-medium text-slate-700 mb-2">Tour Name</span>
                        <input type="text" name="tour_name" class="h-9 w-full pl-2 py-1 border border-violet-200 rounded focus:outline-none focus:ring ring-violet-300" placeholder="Ex:.Paris, Safi" value="<?= $data["tour_name"]?>"/>
                    </label>
                    <label class="block w-full">
                        <span class="block text-sm font-medium text-slate-700 mb-2">Tour Destination</span>
                        <input type="text" name="tour_destination" class="h-9 w-full pl-2 py-1 border border-violet-200 rounded focus:outline-none focus:ring ring-violet-300" placeholder="Ex:.Greece, Morocco" value="<?= $data["tour_destination"]?>"/>
                    </label>
                    <label class="block w-full">
                        <span class="block text-sm font-medium text-slate-700 mb-2">Tour Price</span>
                        <input type="number" name="tour_price" class="h-9 w-full pl-2 py-1 border border-violet-200 rounded focus:outline-none focus:ring ring-violet-300" placeholder="Ex:.$100" value="<?= $data["tour_price"]?>"/>
                    </label>
                    <label class="block w-full col-span-full">
                        <span class="block text-sm font-medium text-slate-700 mb-2">Tour Description</span>
                        <textarea name="tour_description" id="description" class="w-full pl-2 py-1 border border-violet-200 rounded focus:outline-none focus:ring ring-violet-300" cols="30" rows="5" placeholder="Ex:.Description"><?= $data["tour_description"]?></textarea>
                    </label>
                    <label class="block col-span-2">
                        ...
                        " value="<?= $data["tour_image"]?>"/>
                    </label>
                    <label class="block col-span-1">
                        <span class="block text-sm font-medium text-slate-700 mb-2">Tour Status</span>
                        <select name="tour_status" class="h-9 w-full pl-2 py-1 border border-violet-200 rounded focus:outline-none focus:ring ring-violet-300" name="status" id="status" value="<?= $data["tour_status"]?>">
                    ...
                    <label class="block col-span-1 col-start-3 w-full">
                        <button type="submit" name="submit" class="w-full border border-2 text-violet-700 rounded mt-5 py-2 px-5 border-violet-800 focus:outline-none focus:ring ring-violet-700 hover:bg-violet-800 hover:text-white transition-colors">Update</button>
                    </label>
                </form>
            </div>
        </div>
